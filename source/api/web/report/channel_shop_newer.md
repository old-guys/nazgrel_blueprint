...
## 渠道新增店主列表 [GET /api/web/report/channel_shop_newers{?device,user_token,channel_id,report_date}]
获取渠道新增店主列表
...
+ Response 200 (application/json;charset=UTF-8)
    + Attributes (object)
        ...
        + data (object)
            ...
            + page: 1 (number) - 页码
            + models (array[SampleReportChannelShopNewer], fixed-type)
...
+ Response 200 (application/json;charset=UTF-8)
    + Attributes (object)
        ...
        + data (object)
            ...
            + models (array[ReportChannelShopNewerTimeType], fixed-type)
